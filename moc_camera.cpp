...
QT_MOC_LITERAL(1, 7, 16), // "send_videoSignal"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 8) // "cv::Mat*"

    },
    "Camera\0send_videoSignal\0\0cv::Mat*"
};
...
void Camera::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->send_videoSignal((*reinterpret_cast< cv::Mat*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Camera::send_videoSignal)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Camera::send_videoSignal(cv::Mat * _t1)
{
